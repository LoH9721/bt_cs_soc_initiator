...
/* 明文帧常用 Flags */
#define PHONE_FLAGS_PLAIN_RSP          (PHONE_FLAG_NEED_RSP | PHONE_FLAG_LAST_FRAG)
#define PHONE_FLAGS_PLAIN_NO_RSP       (PHONE_FLAG_LAST_FRAG)
/* 加密帧 Flags */
#define PHONE_FLAGS_ENCRYPTED_RSP      (PHONE_FLAG_NEED_RSP | PHONE_FLAG_LAST_FRAG | PHONE_FLAG_HAS_AUTH_TAG | PHONE_FLAG_ENCRYPTED)
...
#define PHONE_TIMEOUT_AUTH_CHALLENGE_MS      5000U  /* AUTH challenge (协议 §22.9: 3→5 秒, 异步加密需余量) */
